...
namespace RabApiWithMvc.Controllers.MVC
{
    public class AEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,EmpName,EmpAddress,DateCreated,isDeleted")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,EmpName,EmpAddress,DateCreated,isDeleted")] Employee employee)
        {
            if (ModelState.IsValid)
            {
