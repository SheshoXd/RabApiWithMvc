...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[ic_v_ContentListing]
AS
SELECT     dbo.ic_Contents.Id, dbo.ic_Contents.Title, dbo.ic_Contents.IntroText, dbo.ic_Contents.FullText, dbo.ic_Contents.ImageId, dbo.ic_Contents.DateCreated, 
                      ...
                      dbo.ic_v_ContentLanguages.EnglishName AS LanguageName, dbo.ic_v_ContentLanguages.LanguageCode, dbo.ic_v_ContentHistories.LogId, 
                      dbo.ic_v_ContentHistories.ActionId, dbo.ic_v_ContentHistories.UserId, dbo.ic_v_ContentHistories.Comments, dbo.ic_v_ContentHistories.FirstName, 
                      dbo.ic_v_ContentHistories.MiddleName, dbo.ic_v_ContentHistories.LastName, dbo.ic_v_ContentHistories.FullName, dbo.ic_Contents.CategoryId, 
                      dbo.ic_Contents.ItemType, dbo.ic_Contents.IsPublished
